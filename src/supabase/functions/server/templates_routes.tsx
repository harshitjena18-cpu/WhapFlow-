...
app.get("/", async (c) => {
  try {
    ...
    // PERFORMANCE: Optimize sorting by using direct lexicographical string comparison on ISO-8601 strings
    // instead of allocating Date objects in the sorting loop. This is ~17x faster and avoids redundant allocations.
    templates.sort((a, b) => {
