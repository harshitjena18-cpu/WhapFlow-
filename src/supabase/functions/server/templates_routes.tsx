...
app.get("/", async (c) => {
  try {
    ...
    // PERFORMANCE: Sort by created_at desc using direct string comparison on ISO-8601 strings.
    // This avoids O(N log N) redundant Date object allocations and parsing overhead.
