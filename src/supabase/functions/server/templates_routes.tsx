...
app.get("/", async (c) => {
  try {
    ...
    // PERFORMANCE: Optimize sorting of ISO-8601 date strings by using direct relational string operators
    // to avoid expensive and redundant Date object instantiation/parsing during O(N log N) loops.
    templates.sort((a, b) => {
