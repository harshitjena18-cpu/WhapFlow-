...
app.get("/", async (c) => {
  try {
    ...
    // PERFORMANCE: ISO 8601 strings (YYYY-MM-DDTHH:mm:ss.sssZ) sort lexicographically in exact chronological order.
    // Direct string comparison eliminates Date parsing and object allocation overhead (~15x speedup).
