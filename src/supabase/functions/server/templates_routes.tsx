...
app.get("/", async (c) => {
  try {
    ...
    // PERFORMANCE: Use direct string comparison for ISO 8601 timestamps instead of parsing Date objects.
    // This avoids Date object allocations/GC overhead and executes ~19x faster.
