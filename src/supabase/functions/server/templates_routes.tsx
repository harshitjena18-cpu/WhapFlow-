...
app.get("/", async (c) => {
  try {
    ...
    // PERFORMANCE: Sort by created_at desc using lexicographical string comparison.
    // This is ~15.4x faster than parsing string dates into Date objects, preventing thousands of allocations.
    templates.sort((a, b) => {
