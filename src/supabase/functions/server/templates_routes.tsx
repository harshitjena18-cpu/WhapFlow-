...
app.get("/", async (c) => {
  try {
    ...
    // PERFORMANCE: Optimize sorting by comparing ISO-8601 date strings directly.
    // This avoids redundant Date object creation during sorting, preventing memory bloat and GC overhead.
    templates.sort((a, b) => {
