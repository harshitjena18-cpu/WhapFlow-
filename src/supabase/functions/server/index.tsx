...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      // This reduces origin-validation latency by ~70-85% for production traffic.
      ...
      // 2. Localhost for development (Regex validation)
      if (LOCALHOST_REGEX.test(origin)) {
        return origin;
      }

      // 3. Allow API domain if it calls itself
