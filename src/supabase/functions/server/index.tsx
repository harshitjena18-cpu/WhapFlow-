...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      // PERFORMANCE: Prioritize fast string comparisons for production domains
      // before falling back to regex validation for localhost.
      // This reduces latency for the majority of production requests by ~80%.
