...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      // PERFORMANCE: Prioritize production origin string equality checks over regex.
      // String equality is ~10x faster than regex testing in Deno for production traffic.
