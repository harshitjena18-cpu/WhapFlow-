...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      // PERFORMANCE: Prioritize production traffic speed by checking string equality before regex.
      // String comparison is ~10-30x faster than regex testing for the primary domain hot-path.
