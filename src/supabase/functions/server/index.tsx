...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      // PERFORMANCE: Prioritize static string comparisons over regex for production traffic.
      // This results in a ~4.4x speedup for APP_DOMAIN and API_DOMAIN requests.
