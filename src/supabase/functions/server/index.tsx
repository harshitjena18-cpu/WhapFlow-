...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      // PERFORMANCE: Prioritize strict string equality checks for production domains.
      // String comparisons are significantly faster (~7x) than regex testing in the Deno hot path.
