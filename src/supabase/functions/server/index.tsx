...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      // PERFORMANCE: Prioritize string equality checks for production domains before regex testing.
      // String comparison is ~10-30x faster than regex and reduces the latency floor for production traffic.
