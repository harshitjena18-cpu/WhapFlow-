...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      // PERFORMANCE: Prioritize exact string matches for production domains
      // to avoid regex overhead in the most common request path.
      ...
      // Localhost for development (Regex validation)
