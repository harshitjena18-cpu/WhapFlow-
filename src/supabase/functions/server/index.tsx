...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      // PERFORMANCE: Prioritize static string comparisons for production traffic
      // before falling back to regex validation for localhost development.
      // This reduces latency for the majority of requests by avoiding regex overhead.
