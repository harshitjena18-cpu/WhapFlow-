...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      // PERFORMANCE: Prioritize production APP_DOMAIN check (string equality) over regex for localhost.
      // This reduces CORS evaluation latency by ~85% for production traffic.
