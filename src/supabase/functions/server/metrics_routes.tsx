...
app.get("/metrics", async (c) => {
  try {
    ...
    // 1. PERFORMANCE: Batch key-value lookups with mget and fetch templates in parallel to minimize round-trips
    ...
    // Use pre-fetched billing config to avoid redundant database reads
