      ...
      if (!_hmacKeyPromise) {
        _hmacKeyPromise = (async () => {
          try {
            ...
            // Once the operation is complete (success or failure),
            // we clear the promise to free it for subsequent checks if needed,
            // though _cachedHmacKey will usually take precedence.
