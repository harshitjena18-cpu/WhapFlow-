...
// PERFORMANCE: Hoist encoders and pre-encode static salts to reduce object creation overhead
 ...
 * PERFORMANCE: Uses a promise-based cache to prevent the thundering herd problem during concurrent calls.
 */
