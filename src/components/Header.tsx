...
export function Header() {
  ...
  useEffect(() => {
    ...
    // PERFORMANCE: Throttle scroll event handling with requestAnimationFrame and passive listener
    // to prevent blocking the main thread during rapid scrolling and reduce state updates.
    let ticking = false;
    const handleScroll = () => {
      if (!ticking) {
