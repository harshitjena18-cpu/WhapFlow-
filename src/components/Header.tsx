      ...
      <div className="flex items-center gap-4 flex-1">
        <div className="relative w-full max-w-md hidden md:block">
          ...
          <input
            ...
            className="w-full pl-10 pr-12 py-2 text-sm bg-white/60 border border-gray-200/50 rounded-lg focus:ring-2 focus:ring-[#25D366]/20 focus:bg-white focus:border-[#25D366]/50 transition-all backdrop-blur-sm outline-none"
          />
