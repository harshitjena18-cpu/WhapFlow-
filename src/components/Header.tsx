      ...
      <div className="flex items-center gap-4 flex-1">
        <div className="relative w-full max-w-md hidden md:block">
          ...
          <input
            ...
            className="w-full pl-10 pr-10 py-2 text-sm bg-white/60 border border-gray-200/50 rounded-lg focus:ring-2 focus:ring-purple-500/20 focus:bg-white focus:border-purple-300/50 transition-all backdrop-blur-sm"
          />
          <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1">
            {searchQuery ? (
              <button
                ...
                className="p-1 rounded-md text-gray-400 hover:text-gray-600 hover:bg-gray-100/80 transition-all active:scale-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/20"
                aria-label="Clear search"
              >
                <X className="w-3.5 h-3.5" />
              </button>
            ) : (
              <div className="pointer-events-none hidden sm:flex items-center gap-1">
