      ...
      <div className="flex items-center gap-4 flex-1">
        <div className="relative w-full max-w-md hidden md:block">
          ...
          <input
            ...
            className="w-full pl-10 pr-12 py-2 text-sm bg-white/60 border border-gray-200/50 rounded-lg outline-none focus:ring-2 focus:ring-purple-500/50 focus:bg-white focus:border-purple-300/50 transition-all backdrop-blur-sm"
          />
