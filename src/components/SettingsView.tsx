          ...
          <div className="px-8 py-8 space-y-6">
            <div className="space-y-3">
              ...
              <Select defaultValue="English">
                <SelectTrigger id="language" className="w-full md:w-64 px-4 py-6 border-gray-200 rounded-xl focus-visible:ring-[#25D366]/20 focus-visible:border-[#25D366]">
            ...
            <div className="space-y-3">
              ...
              <Select defaultValue="UTC-8 (Pacific Time)">
                <SelectTrigger id="timezone" className="w-full md:w-64 px-4 py-6 border-gray-200 rounded-xl focus-visible:ring-[#25D366]/20 focus-visible:border-[#25D366]">
