        ...
        <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
          ...
          <div className="px-8 py-8 flex flex-col sm:flex-row justify-between items-center gap-6">
             ...
             <Button
               ...
               className="px-6 py-2.5 h-auto bg-purple-600 text-white rounded-xl hover:bg-purple-700 font-semibold text-sm transition-all shadow-sm"
             >
               View Plans
             </Button>
          </div>
          ...
          <div className="px-8 py-8 space-y-6">
            <div className="space-y-3">
              ...
              <Select defaultValue="English">
                <SelectTrigger
                  id="language"
                  className="w-full md:w-64 h-auto px-4 py-3 border-gray-200 rounded-xl text-sm focus-visible:ring-[#25D366]/20 focus-visible:border-[#25D366] bg-white cursor-pointer"
                >
