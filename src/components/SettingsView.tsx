    ...
    <div className="space-y-10">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
          ...
          <div className="px-8 py-8 space-y-6">
            <div className="space-y-3">
              <Label htmlFor="language-select" className="text-xs font-semibold text-gray-500 uppercase tracking-wide">
                Language
              </Label>
              <Select defaultValue="English">
                <SelectTrigger id="language-select" className="w-full md:w-64 h-auto px-4 py-3 border-gray-200 rounded-xl text-sm">
            ...
            <div className="space-y-3">
              <Label htmlFor="timezone-select" className="text-xs font-semibold text-gray-500 uppercase tracking-wide">
                Timezone
              </Label>
              <Select defaultValue="UTC-8 (Pacific Time)">
                <SelectTrigger id="timezone-select" className="w-full md:w-64 h-auto px-4 py-3 border-gray-200 rounded-xl text-sm">
