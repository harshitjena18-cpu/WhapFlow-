      ...
      <div className="space-y-6">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
          ...
          <div className="px-8 py-8 space-y-6">
            ...
            <Button
              onClick={handleSave}
              disabled={isSaving}
              className="px-8 py-6 bg-[#25D366] text-white rounded-xl hover:bg-[#20BD5A] font-semibold text-sm transition-all shadow-sm active:scale-95"
            >
        ...
        <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
          ...
          <div className="px-8 py-8 flex flex-wrap gap-3">
            <Button variant="outline" className="px-6 py-3 h-auto border-gray-200 text-gray-900 rounded-xl hover:bg-gray-50 font-semibold text-sm transition-colors active:scale-95">
              Change Password
            </Button>
            <Tooltip>
          ...
          <div className="px-8 py-8 space-y-6">
            <div className="space-y-3">
              ...
              <Select defaultValue="English">
                <SelectTrigger id="language" className="w-full md:w-64 h-auto px-4 py-3 border-gray-200 rounded-xl focus:ring-[#25D366]/20 focus:border-[#25D366]">
            ...
            <div className="space-y-3">
              ...
              <Select defaultValue="UTC-8 (Pacific Time)">
                <SelectTrigger id="timezone" className="w-full md:w-64 h-auto px-4 py-3 border-gray-200 rounded-xl focus:ring-[#25D366]/20 focus:border-[#25D366]">
