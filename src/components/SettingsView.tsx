          ...
          <div className="px-8 py-8 space-y-6">
            <div className="space-y-3">
              ...
              <Select defaultValue="English">
                <SelectTrigger
                  id="language"
                  className="w-full md:w-64 px-4 py-3 h-auto border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#25D366] transition-colors bg-white cursor-pointer shadow-none ring-offset-0 focus:ring-0 focus-visible:ring-0"
                >
