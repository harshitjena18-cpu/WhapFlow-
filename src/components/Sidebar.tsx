        ...
        <div className="px-4 py-6 border-t border-gray-100">
          {loading ? (
            ...
            <Link
              ...
              className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50 transition-all duration-200 active:scale-[0.98] group/profile outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/20"
            >
              <div className="w-9 h-9 bg-[#25D366] rounded-full flex items-center justify-center flex-shrink-0 group-hover/profile:shadow-sm transition-all">
              ...
              <ChevronRight className="w-4 h-4 text-gray-400 group-hover/profile:text-gray-600 group-hover/profile:translate-x-0.5 transition-all" />
            </Link>
          )}
        </div>
      </aside>
