  ...
  return (
    <>
      ...
      >
        ...
        {/* User Profile */}
        <div className="px-4 py-6 border-t border-gray-100 flex items-center gap-2">
          {loading ? (
             <div className="flex items-center gap-3 px-3 py-2 rounded-lg flex-1">
            ...
            <>
              <Link
                to="/settings"
                onClick={() => setIsMobileMenuOpen(false)}
                className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50 transition-all active:scale-[0.98] outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/20 flex-1 min-w-0"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900 truncate transition-colors">{displayName}</p>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    size="icon"
                    onClick={() => signOut()}
                    className="h-9 w-9 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all active:scale-95 flex-shrink-0"
                    aria-label="Sign out"
                  >
