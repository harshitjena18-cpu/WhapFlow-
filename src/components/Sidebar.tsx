  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-6 right-6 z-50 p-3 rounded-xl bg-white border border-gray-100 hover:bg-gray-50 transition-all active:scale-95 focus-visible:ring-2 focus-visible:ring-[#25D366]/50 focus-visible:outline-none"
