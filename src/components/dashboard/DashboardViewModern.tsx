        ...
        >
          <div className="flex justify-between items-start mb-6">
            ...
            <Select defaultValue="Monthly">
              <SelectTrigger
                className="w-[110px] h-8 text-xs border-gray-200 rounded-lg px-2 py-1 text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                aria-label="Select timeframe for cart distribution"
              >
