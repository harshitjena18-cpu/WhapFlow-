    ...
    <div className="space-y-6 pb-8">
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <motion.button 
            className="px-4 py-2 bg-gradient-to-r from-teal-500 to-emerald-500 text-white rounded-lg text-sm font-semibold hover:shadow-lg hover:shadow-teal-500/30 transition-all flex items-center gap-2 outline-none focus-visible:ring-2 focus-visible:ring-teal-500/20"
