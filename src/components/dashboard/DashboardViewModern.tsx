        ...
        >
          <div className="flex justify-between items-start mb-6">
            ...
            <Select defaultValue="Monthly">
              <SelectTrigger aria-label="Cart distribution timeframe" className="w-28 h-8 text-xs border-gray-200 rounded-lg focus-visible:ring-2 focus-visible:ring-teal-500">
