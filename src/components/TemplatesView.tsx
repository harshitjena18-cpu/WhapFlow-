...
export function TemplatesView() {
  ...
  // PERFORMANCE OPTIMIZATION: Derive validation errors and warnings using useMemo instead of useEffect/useState
  // to avoid cascading secondary re-renders on every keystroke when editing template content.
