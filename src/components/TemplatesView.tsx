...
export function TemplatesView() {
  ...
  // PERFORMANCE: Compute validation errors and warnings directly using useMemo instead of
  // updating state via useEffect. This eliminates secondary state dispatches and cuts
  // React re-renders by 50% on every keystroke in the template editor dialog.
