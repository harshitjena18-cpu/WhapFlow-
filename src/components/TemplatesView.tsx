            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  required
                />
                <p id="display-name-description" className="text-[10px] text-gray-500">Internal name for your reference.</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  aria-describedby="template-name-description"
                  required
                />
                <p id="template-name-description" className="text-[10px] text-gray-500">MUST match the exact name in Meta Business Manager.</p>
              </div>
              ...
              <div className="space-y-2 h-full flex flex-col">
                ...
                <Textarea 
                  ...
                  aria-describedby="template-content-warning"
                  required
                />
                ...
                <div id="template-content-warning" className="bg-blue-50 text-blue-800 p-2 rounded text-[10px] border border-blue-100 flex items-start gap-2 mt-1">
