...
export function TemplatesView() {
  ...
  // PERFORMANCE: Compute validation errors and warnings using useMemo directly during render
  // to eliminate secondary state dispatches (setValidationErrors/setValidationWarnings) and cut re-renders by 50% on every keystroke.
