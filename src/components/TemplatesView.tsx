...
export function TemplatesView() {
  ...
  // PERFORMANCE OPTIMIZATION (Bolt ⚡): Derived state via useMemo prevents duplicate re-renders
  // on every single keystroke, eliminating the redundant state update cycles.
