...
// PERFORMANCE: Hoist static template variables outside component to prevent re-allocation.
...
// PERFORMANCE: Compute modifier key once outside the component as it's environment-dependent but static.
...
export function TemplatesView() {
  ...
  // PERFORMANCE: Use useMemo for validation to avoid redundant render cycles on every keystroke.
  // Previously this used useEffect + useState which triggered an extra render pass.
