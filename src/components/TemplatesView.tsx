...
export function TemplatesView() {
  ...
  // Optimization: Derive validation warnings and errors directly via useMemo during render.
  // This avoids setting state in useEffect on every keystroke, cutting React re-renders by ~50%.
