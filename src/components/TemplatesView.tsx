...
// PERFORMANCE: Hoist OS detection and static data outside the component to prevent redundant computations/allocations
...
export function TemplatesView() {
  ...
  // PERFORMANCE: Use useMemo for validation instead of useEffect + useState.
  // This eliminates a redundant re-render cycle per keystroke in the template editor.
