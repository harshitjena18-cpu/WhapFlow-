            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 h-full flex flex-col">
                ...
                <Progress
                  ...
                  className={`h-1.5 mb-1 ${(formData.content?.length || 0) > 1024 ? '[&_[data-slot=progress-indicator]]:bg-red-500' : (formData.content?.length || 0) > 921 ? '[&_[data-slot=progress-indicator]]:bg-orange-500' : ''}`}
                />
                ...
                <Textarea 
                  ...
                  aria-describedby="char-counter validation-msg"
                />
                
                {/* Validation Messages */}
                <div id="validation-msg" className={`space-y-2 ${validationErrors.length > 0 || validationWarnings.length > 0 ? 'mt-1' : ''}`}>
