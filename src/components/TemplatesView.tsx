                ...
                {loading ? (
                  ...
                  templates.map((template) => (
                    <button
                      ...
                      className={`w-full px-4 py-4 text-left transition-all hover:bg-gray-50 flex items-start gap-3 group outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/20 focus-visible:ring-offset-2 active:scale-[0.98] ${
