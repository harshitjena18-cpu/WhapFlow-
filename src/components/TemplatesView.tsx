...
export function TemplatesView() {
  ...
  // React Optimization Pattern: Computing validation state with useMemo avoids secondary useState dispatches
  // inside useEffect, cutting component re-renders by 50% during template editing.
  const { validationErrors, validationWarnings } = useMemo(() => {
    if (!isDialogOpen) return { validationErrors: [] as string[], validationWarnings: [] as string[] };
