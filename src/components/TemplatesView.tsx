...
export function TemplatesView() {
  ...
  // PERFORMANCE: Compute validation errors/warnings synchronously during render using useMemo.
  // Deriving validation directly from state prevents secondary state updates (setValidationErrors/setValidationWarnings)
  // inside useEffect, cutting React re-renders by 50% on every keystroke in the template editor dialog.
