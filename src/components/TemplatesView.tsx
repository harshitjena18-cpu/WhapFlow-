                ...
                {aiUsage && (
                  <div className="bg-gray-50 rounded-lg p-3 border border-gray-100 space-y-2">
                    ...
                    <Progress
                      ...
                      className={cn(
                        "h-1.5",
                        usagePercentage >= 100 ? "[&_[data-slot=progress-indicator]]:bg-red-500" :
                        usagePercentage >= 80 ? "[&_[data-slot=progress-indicator]]:bg-orange-500" : ""
                      )}
                    />
                    {isLimitReached && (
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 h-full flex flex-col">
                ...
                <Progress
                  ...
                  className={cn(
                    "h-1.5 mb-1",
                    (formData.content?.length || 0) > 1024 ? "[&_[data-slot=progress-indicator]]:bg-red-500" :
                    (formData.content?.length || 0) > 921 ? "[&_[data-slot=progress-indicator]]:bg-orange-500" :
                ...
                <Textarea 
                  ...
                  aria-describedby="content-char-count content-validation-feedback"
                />
                
                {/* Validation Messages */}
                <div id="content-validation-feedback" className="min-h-[1px]">
