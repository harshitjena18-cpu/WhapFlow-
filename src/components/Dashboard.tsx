    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 flex">
      ...
      >
        ...
        <div className="p-4 border-t border-gray-100">
          ...
          className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 transition-all duration-200 overflow-hidden active:scale-95 outline-none focus-visible:ring-2 focus-visible:ring-ring/20"
          >
