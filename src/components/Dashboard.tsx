      ...
      >
        ...
        <div className="p-4 border-t border-gray-100">
          <Link
            ...
            className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 transition-all duration-200 overflow-hidden active:scale-[0.98] outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/50"
          >
