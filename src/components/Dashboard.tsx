...
// PERFORMANCE: Hoist static data outside component to avoid re-allocating array on every parent re-render.
...
// PERFORMANCE: Memoize MetricCard and pass Component reference for shallow equality (Object.is) checks.
