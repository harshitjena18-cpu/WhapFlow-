// PERFORMANCE: Hoist regex objects to the module level to avoid repeated allocation and compilation overhead
// during frequent error handling and logging operations.
